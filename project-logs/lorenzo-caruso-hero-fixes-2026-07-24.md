...
## Files Touched
- `index.html`: Updated Section 2 HTML for mobile-first card 3-row layout, embedded generated `assets/italy_map_dark.png` in Card 2 slot, removed tagline element, and updated dark block DOM order (Logo -> Hairline -> Marquee).
...
- **Section 2 Rebuild**: Mobile-first card text, removed tagline, extended hairline to marquee, and generated dark Italy map placed in Card 2 slot.
